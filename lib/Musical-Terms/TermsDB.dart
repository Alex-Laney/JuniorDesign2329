...
class TermsDB {
  ...
  //Declare terms here
  static Term allegro = Term("Allegro", "A brisk and lively tempo.",
      ["The tempo of Vivaldi's Spring is allegro."], [Tags.musicTheory]);
  static Term chord = Term("Chord", "A set of notes played simultaneously.",
      ["Chords are generally harmonious."], [Tags.musicTheory]);
  static Term scale = Term("Scale", "A sequence of notes ordered by pitch.",
      ["Scales are the foundation of music."], [Tags.musicTheory]);
