...
class QuizDB {
  ...
  static Widget? getQuestion(
      Quiz quiz, int qNum, BuildContext context, Function onPressed) {
    if (qNum >= quiz.questionList.length) {
      return null;
    }
    return quiz.questionList[qNum].display(
        quiz: quiz, qNum: qNum, context: context, onPressed: onPressed);
  }
}
